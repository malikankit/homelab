# Generated by Powerlevel10k configuration wizard on 2026-08-15 at 17:26 EDT.
...
() {
  ...
  # Always show context (user@hostname) — homelab has 4 machines, always
  # want to know which one a prompt belongs to.
